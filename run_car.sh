...
gnome-terminal --tab --title="Microphone" -- bash -c 'python3 ./recording_node.py; exec bash'

gnome-terminal --window --title="Road runner" -- bash -c 'python3 road_runner.py; exec bash'